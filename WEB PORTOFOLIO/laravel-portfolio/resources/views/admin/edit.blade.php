    ...
    <div class="form-container">
        <form action="{{ route('projects.update', $project) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="year" required value="{{ old('year', $project->year) }}">
            ...
            <button type="submit" class="btn" style="background: linear-gradient(135deg, #f59e0b, #d97706);">Update Data</button>
